...
<body>
    ...
    <div class="col-md-10 offset-md-1 col-sm-12 pb-5">
          ...
          <h4 style="font-family: 'Inter', sans-serif;margin:2%;padding:1%;font-weight: 600 !important;" class="text-center"><i class="fa-solid fa-user-check"></i>&nbspUSER LOGIN</h4>
